...
class WeightKsz(Projection):
   ...
   def f(self, a):
      ...
      result = self.U.rho0 * self.U.OmB / self.U.OmM   # comoving baryon density [(Msun/h) / (Mpc/h)^3]
      ...
      factor = (me + nH_ne*mH + nHe_ne*mHe) / (msun/self.U.h)   # [Msun/h]
      ...
      sigma_T *= (self.U.h/mpc)**2  # convert to (Mpc/h)^2
      result *= sigma_T
